<template>
    <div class="overflow-x-auto">
      <div class="min-w-screen flex font-sans rounded">
        <div class="w-full">
          <div class="rounded mt-4 h-80 overflow-y-auto scrollbar border-b-2 overflow-x-auto scrollbar">
            <table class="min-w-max w-full table-auto">
              <thead class="sticky top-0 z-10">
                <tr
                  class="bg-gray-100 text-gray-600 uppercase text-sm leading-normal"
                >
                  <th class="py-3 px-6 text-left">Actioned</th>
                  <th class="py-3 px-6 text-left">Item</th>
                  <th class="py-3 px-6 text-center">Due Date</th>
                </tr>
              </thead>
              <tbody v-for="meetingItem in meetingsItems" :key="meetingItem.id" class="text-gray-600 text-sm font-light">
